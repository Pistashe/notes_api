...
encrypter = EncrypterAsymmetric()
encrypter2 = EncrypterAsymmetric()
encrypter.public_key = encrypter2.private_key.public_key
encrypter2.public_key = encrypter.private_key.public_key

notebook.save(encrypter)

notebook2 = Notebook.from_archive("notebook_archive.tar", encrypter2)
notebook2.display(displayer)
...
# test.display(displayer)
# notebook.save()
# notebook2 = Notebook.from_archive("notebook_archive.tar")
# notebook2.display(displayer)
